...
local opcodes = {
    ...
    [0xb0] = {  1,  -1, 'areturn'},
    [0xb1] = {  1,   0, 'return'},
    [0xb2] = {  3, nil, 'getstatic'},
    [0xb3] = {  3, nil, 'putstatic'},
    [0xb4] = {  3, nil, 'getfield'},
    [0xb5] = {  3, nil, 'putfield'},
...
for i = 0, 255 do
    ...
    if op and not op[2] then
        io.write('-- ', op[3], '\n')
        io.write(string.format('deltas[0x%02x] = function(b, cpool)\n', i))
        io.write('end\n\n')
    end
end

io.write('local sizes = { [0] =\n')
